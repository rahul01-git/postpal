...
exports.status = exports.statusData = void 0;
exports.statusData = {
    errors: {
        badRequest: {
            code: 400,
...
exports.status = {
    errors: Object.fromEntries(Object.entries(exports.statusData.errors).map(([key, value]) => [key, value.code])),
    success: Object.fromEntries(Object.entries(exports.statusData.success).map(([key, value]) => [key, value.code])),
};
